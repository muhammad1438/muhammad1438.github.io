...
- **DFT Software**: Quantum ESPRESSO, VASP, Gaussian, Materials Studio
- **Molecular Dynamics**: LAMMPS (Large-scale Atomic/Molecular Massively Parallel Simulator)
- **Chemical Kinetics**: Cantera, CHEMKIN-PRO for reaction mechanism analysis

**Experimental & Analytical Techniques:**
- **Characterization**: XRD, XPS, Raman Spectroscopy, BET, SEM, EDS
- **Synthesis Methods**: Sol-gel processing, Flame synthesis, Wet impregnation, CVD
...
- **Belt and Road Fellowship** - University of Chinese Academy of Sciences (2017-2020)
- **Top Crisis Manager** - University of Engineering and Technology (2016)
...
> **11+ peer-reviewed publications** in high-impact journals including *ACS Omega*, *Materials Research Bulletin*, *Proceedings of the Combustion Institute*, and *Industrial & Engineering Chemistry Research*.

📊 **Citation Metrics**: 82+ total citations | **h-index**: Available on [Google Scholar](https://scholar.google.com/citations?user=fwiNZasAAAAJ)

🔗 **Complete Publication List**: Visit my [professional website](https://muhammad1438.github.io/) for the full list with links and citation counts.
...
<p align="center">
  <i>⭐ From <a href="https://github.com/muhammad1438">muhammad1438</a> | Professional CV website with automated publication tracking | Inspired by <a href="https://github.com/zumrudu-anka/zumrudu-anka">zumrudu-anka</a></i>
</p>